...
def LocalSearchHelper(model, image, noise, label, sess, blocks, tot_num_queries,  y_input, test_in, 
                     losses, preds, _perturb_image, args, **kwargs):
    ...
    losses_int, preds_int = sess.run((losses,preds), feed_dict={test_in: image_batch,
                                                                y_input: label_batch})
