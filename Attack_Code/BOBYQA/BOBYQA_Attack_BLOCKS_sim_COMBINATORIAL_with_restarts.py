...
class BlackBox_BOBYQA:
    ...
    def blackbox_optimizer(self, iteration):
        ...
        soln = pybobyqa.solve(opt_fun, x_o, rhobeg=self.L_inf/3,
                              bounds=(a, b), maxfun=self.batch_size*2.2,
    ...
    def attack_batch(self, img, lab):
        ...
        if np.any(self.perturbed_img != 0):
            ...
            # print('New Dimension is ', dimen[idx])
        ...
        for step in range(self.steps_done+1, self.MAX_ITERATIONS):
            ...
            if internal_eval_costs > self.max_eval_internal:
                ...
                values={'steps':step, 'iteration_scale':iteration_scale, 'ord_domain':ord_domain}
