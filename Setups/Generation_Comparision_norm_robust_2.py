...
# In[2]:
flags = tf.app.flags
flags.DEFINE_string('dataset', 'mnist', 'model name')
...
flags.DEFINE_integer('max_iters', 2, help='maximum iterations') ##########
...
class args_CLASS(object): #= vars(parser.parse_args())
    dataset = 'mnist'            # choices=["mnist", "cifar10", "imagenet"], default="mnist")
    save = './Results/'
