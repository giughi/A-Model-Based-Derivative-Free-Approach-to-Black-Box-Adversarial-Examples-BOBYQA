...
from Attack_Code.BOBYQA.BOBYQA_Attack_Adversary_linear import BlackBox_BOBYQA
...
if __name__ == '__main__':
    ...
    saving_name_boby = saving_dir+'boby_linear_L_inf_'+str(L_inf_var)+'_max_eval_'+ str(FLAGS.max_evals) + case + '.txt'
    ...
    for i in range(already_done_init,args['numimg']):
        ...
        def loss_func(img, pert, only_loss=False):
            ...
            # print('=========== pert size', pert[0].shape, len(pert))
            for i in range(nn):
