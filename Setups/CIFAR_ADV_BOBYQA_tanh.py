...
from Attack_Code.BOBYQA.BOBYQA_Attack_Adversary_tanh import BlackBox_BOBYQA
...
if __name__ == '__main__':
    ...
    saving_name_boby = saving_dir+'boby_tanh_L_inf_'+str(L_inf_var)+'_max_eval_'+ str(FLAGS.max_evals) + case + '_2.txt'
    ...
    for i in range(already_done_init,args['numimg']):
        ...
        attack_dist = BlackBox_BOBYQA(loss_func, batch_size=25 , max_iterations=10000, print_every=1, 
