...
python main_MBAE.py --input_dir=./images/ --test_size=1 \
    --eps=0.05 \
...
from BOBYQA_Attack_BLOCKS_sim_COMBINATORIAL import BlackBox_BOBYQA
    ...
    with tf.Session() as sess:
        ...
        for ii in range(num_valid_images):
            ...
            if result is not None:
                ...
                with open('summary_rand_attack.txt', "wb") as fp:  # Pickling
