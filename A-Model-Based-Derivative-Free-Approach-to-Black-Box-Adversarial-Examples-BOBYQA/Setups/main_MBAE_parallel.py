...
python main_MBAE_parallel.py --input_dir=./images/ --test_size=1 \
    --eps=0.05 \
...
from BOBYQA_Attack_Parallel import BlackBox_BOBYQA
...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        attack = BlackBox_BOBYQA(sess, model, batch_size=50, max_iterations=10000, print_every=10,
                                 ...
                                 L_inf=FLAGS.eps, rank=3, ordered_domain=True,
                                 image_distribution=True, max_eval=100000)
