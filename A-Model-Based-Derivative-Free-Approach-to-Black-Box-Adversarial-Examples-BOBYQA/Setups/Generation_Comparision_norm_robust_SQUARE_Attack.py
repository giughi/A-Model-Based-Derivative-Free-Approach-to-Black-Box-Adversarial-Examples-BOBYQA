...
def square_attack_linf(sess, model, x, y, eps, n_iters, p_init):
...
if __name__ == '__main__':
    ...
    for L_inf_var in L_inf_var_list:
        ...
        if FLAGS.dataset == 'mnist':
            saving_name_dist = main_dir + '/Results/MNIST/Square_summary_dist_L_inf_'+str(L_inf_var)+'_adv_'+str(FLAGS.Adversary_trained)+'.txt'
        else:
            saving_name_dist = main_dir + '/Results/CIFAR/Square_summary_dist_L_inf_'+str(L_inf_var)+'_adv_'+str(FLAGS.Adversary_trained)+'.txt'
        ...
        #     use_log = args['use_zvalue']
            ...
            if FLAGS.dataset == 'mnist':
                saving_dir = main_dir + '/Results/MNIST/Square' + FLAGS.description
            else:
                saving_dir = main_dir + '/Results/CIFAR/Square' + FLAGS.description
...
# python Setups/Generation_Comparision_norm_robust.py --max_evals=1400 --attack_type=boby --dataset=mnist