...
from Attack_Code.Combinatorial.attacks.local_search_helper import LocalSearchHelper
...
class ParsimoniousAttack(object):
  ...
  def _perturb_image(self, image, noise):
    ...
    adv_image = image + Image.open(noise[0, ...]).resize((self.width, self.height), Image.NEAREST)
